...
<div id="futureReservations">
    ...
    <c:if test="${empty futereReserved}">
        <spring:message code="apartmentDetail.noReserved" />
    </c:if>
    <c:if test="${not empty futereReserved}">
        <table class="table">
            <tr>
            ...
            <c:forEach items="${futereReserved}" var="reserv">
                <tr>
                    ...
                    <td><a href="#" appId="${reserv.id}" class="btn btn-warning delReservation">
